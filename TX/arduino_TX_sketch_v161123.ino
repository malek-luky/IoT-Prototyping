...
void loop()
{
    ...
    float DHT_tempTX = DHT.temperature;
    float DHT_humTX = DHT.humidity;
    //Serial.print("Temperature = ");
    //Serial.println(DHT_tempTX);
    //Serial.print("Humidity = ");
    //Serial.println(DHT_humTX);
    Serial.print("PRESSURE = ");
    Serial.println(fsrReading);

    uint8_t TX_buffer[] = {fsrReading, DHT_tempTX, DHT_humTX};
    myLora.txBytes(TX_buffer, sizeof(TX_buffer));
